    ...
    @include('admin.lightnavbar')
      <div class="container-fluid">
        ...
        @endif
          ...
          <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Müsaitlik Durumu Belirle</h5>
                <form action="{{url('lightmusaitlikdegistir')}}" method="POST" >
                @csrf
                <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Müsaitlik Durumu</label>
